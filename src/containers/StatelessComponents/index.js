  ...
  return (
    <div>
      ...
      <p>
        ...
        it, no state. This means that the component will not have any state that
        it will be in charge of updating the view. We'll dive deeper to what
        state is in a later chapter.
      </p>
